   ...
   <div class="msite_shop_list">
      ...
      <div class="shop_container">
        <ul class="shop_list" v-if="shops.length>0">
          <!--用vue的指令v-for进行循环遍历   强制绑定动态的设置key的值 -->
              ...
              <div class="shop_right">
                ...
                <section class="shop_rating_order">
                  <section class="shop_rating_order_left">
                            ...
                            <!-- 星星显示组件 -->
                            <!-- 向子组件传递参数 -->
                    <Star :size="24" :rating="shop.rating"></Star>
        ...
        <ul>
          <li>
            <img src="./images/shop_back.svg" alt="aa">
...
//引入vuex中的映射方法，以便于进行状态数据的获取
import {mapState} from 'vuex';
  export default {
    //直接获取vuex里面的状态数据。  组件中获取需要放在计算属性中获取。
    computed:{
      ...mapState(['shops'])
    }
